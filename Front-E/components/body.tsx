        ...
        <div>
            ...
            <section>
                ...
                <div className="text-center p-6 tracking-widest mt-6 my-6">
                    <button className="border-2 border-black bg-black text-white p-4 w-96 font-light tracking-widest uppercase transition duration-300 ease-in-out transform hover:bg-white hover:text-black hover:scale-105">
                        VER MÁS PRODUCTOS
                    </button>
                </div>
