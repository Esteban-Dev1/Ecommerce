                    ...
                    <div className='flex justify-between items-center p-4'>
                        <nav>
                            <div>
                                ...
                                <ul>
                                    <li className='text-white hover:text-emerald-100 cursor-pointer	 leading-10'>Centro de Ayuda</li>
                                    <li className='text-white hover:text-emerald-100 cursor-pointer	 leading-10'>Atencion por Whatsapp</li>
                                    <li className='text-white hover:text-emerald-100 cursor-pointer	 leading-10'>Tipos de entrega</li>
                                    <li className='text-white hover:text-emerald-100 cursor-pointer	 leading-10'>Preguntas Frecuentes</li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                    ...
                    <div className='flex justify-between items-center p-4'>
                        <nav>
                            <div>
                                ...
                                <ul>
                                    <li className='text-white hover:text-emerald-100 cursor-pointer	 leading-10'>Sobre nosotros</li>
